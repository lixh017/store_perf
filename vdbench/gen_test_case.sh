...
vd_conf=\`/bin/bash \${dir}/../../genvdbench.sh -d \${test_file} \${cache_flag} ${run_falg} \${run_time_flag} -b ${rs} \${size_flag} \${host_list_flag} -m ${mode} \${run_time_flag}  -t ${th} -M ${mix} -x \${run_result_dir}/\`
